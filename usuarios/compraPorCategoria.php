<?php require_once "../includes/lib_carrito.php"; 
	...
	if (isset($seleccionado) && $seleccionado!='' && $seleccionado!=NULL) {
				...
				<div class="grid-12 grid"> 
	            	<div class="flexsearch">
						<div class="flexsearch--wrapper">
							<form class="flexsearch--form" action="compraPorCategoria.php#listadoProductos" method="get">
								...
								<!-- <input class="flexsearch--clean" type="button" id="limpiar" name="limpiar" title="limpiar" value="&#10006;" onclick="document.location='compraPorCategoria.php?bnombre='" /> -->
