<?php
	...
	header ("Content-Disposition: attachment; filename=ProductosMasDemandados.xls" );
		
	$consulta = "select * FROM VW_PRODUCTOS_MAS_DEMANDADOS";
...
<body>
	...
	<table class="tablaResultados">
			<tr bgcolor="#000066" style="color: white; border: 2px solid #CCCCCC; font-weight: bolder;">
				<td colspan="2" align="center"><b>PRODUCTOS MÁS DEMANDADOS</b></td>
			</tr>
